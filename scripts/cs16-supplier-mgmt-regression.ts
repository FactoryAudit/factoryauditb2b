...
(async () => {
  ...
  // =========================================================================
  {
    ...
    check("A5 cs13 F1i 常量 = 2970", has("scripts/cs13-supplier-seo-regression.ts", "EN_LEAF_COUNT = 2970"));
    check("A6 verify-opennext-bundle 常量 = 2970", has("scripts/verify-opennext-bundle.mjs", "cnt !== 2970") && has("scripts/verify-opennext-bundle.mjs", "(期望 2970)"));
