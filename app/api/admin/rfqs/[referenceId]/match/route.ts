...
import { recommendSuppliersForRfq, confirmRfqMatches } from "@/lib/rfqMatching";

// STEP 12 Change Set D —— Admin 查看推荐结果 + 手动确认匹配
...
// 第一版**不**自动发送给供应商，只写 rfq_matches 供 Admin 复核。
